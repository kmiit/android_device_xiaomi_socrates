package org.lineageos.dt2w.Socrates;
...
public class DT2WServiceSocrates extends Service {
    private static final String TAG = "DT2WServiceSocrates";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.socrates.dt2w", dt2wEnabled ? "1" : "0");
        }
